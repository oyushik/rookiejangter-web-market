...
public class User extends BaseEntity {
    ...
    private List<com.miniproject.rookiejangter.entity.Review> buyerReviews = new ArrayList<>();

    @OneToMany(mappedBy = "seller", cascade = CascadeType.ALL, orphanRemoval = true)
    private List<Review> sellerReviews = new ArrayList<>();

    @OneToMany(mappedBy = "buyer", cascade = CascadeType.ALL, orphanRemoval = true)
    private List<com.miniproject.rookiejangter.entity.Reservation> buyerReservations = new ArrayList<>();

    @OneToMany(mappedBy = "seller", cascade = CascadeType.ALL, orphanRemoval = true)
    private List<Reservation> sellerReservations = new ArrayList<>();

    @OneToMany(mappedBy = "buyer", cascade = CascadeType.ALL, orphanRemoval = true)
    private List<com.miniproject.rookiejangter.entity.Chat> buyerChats = new ArrayList<>();
    ...
    @OneToMany(mappedBy = "buyer", cascade = CascadeType.ALL, orphanRemoval = true)
    private List<com.miniproject.rookiejangter.entity.Complete> buyerCompletes = new ArrayList<>();
